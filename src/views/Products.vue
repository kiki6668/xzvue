...
<div>
  <my-header></my-header>
  <h2 id="computer" class="stair"><span><img src="../assets/itemCat/computer_icon.png" alt=".stair"/></span>办公电脑 /1F</h2>
  <div class="lf1">
    <div class="lf1_top" v-for="(a,b) of others" :key="b">
      <div class="left lf">
        <div class="left_pro lf">
          <p class="top_ys1">{{a.sold_count}}</p>
          <p class="top_ys2">
            {{a.title}}
          </p>
          <p class="top_ys3">￥{{a.price}}</p>
          <p class="top_ys4 color_2"><router-link :to="`/details/${a.lid}`">查看详情</router-link></p>
        </div>
        <span><img src="../assets/itemCat/study_computer_img1.png" alt=""/></span>
      </div>
